...
+ "<" + document.getElementById("hdNickName").value + "<" + document.getElementById("hdType1").value + "<" + document.getElementById("hdType4").value + "<" + document.getElementById("hdUserType").value;
...
<body>
    ...
    <div id="divmain">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="747"
            id="CMOP_HallClient">
            <param name="movie" value="/Flash/CMOP_HallClientV2.swf" />
            <param name="quality" value="high" />
            <param name="bgcolor" value="#ffffff" />
            <param name="allowScriptAccess" value="always" />
            <param name="allowFullScreen" value="true" />
            <!--[if !IE]>-->
            <object type="application/x-shockwave-flash" data="/Flash/CMOP_HallClientV2.swf"
                width="100%" height="747">
                <param name="quality" value="high" />
                <param name="bgcolor" value="#ffffff" />
                <param name="allowScriptAccess" value="always" />
                <param name="allowFullScreen" value="true" />
