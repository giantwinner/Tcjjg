...
function writeIframe() {
    ...
    strIframe += "<td colspan=3 class=out title='" + WebCalendar.regInfo + "'>" +
         ...
         WebCalendar.btnBgColor + ";cursor: hand; padding-top: 4px; width: 30px; height: 100%; border: 0' onfocus='this.blur()'" +
         " type=button value=' 清除' onclick='parent.clearCalendar()'>" +
         "<input style=' background-color: " +
         WebCalendar.btnBgColor + ";cursor: hand; padding-top: 4px; width: 38px; height: 100%; border: 0' onfocus='this.blur()'" +
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.darkColor = "#5298D2";    //控件的暗色
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#6BAADE";    //控件的按钮背景色
    this.wordColor = "#000080";    //控件的文字颜色
    this.wordDark = "#DCDCDC";    //控件的暗文字颜色
    this.dayBgColor = "#F5F5FA";    //日期数字背景色
    this.todayColor = "#045E9C";    //今天在日历上的标示背景色
