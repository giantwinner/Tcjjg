<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PasswordProtect.aspx.cs"
    Inherits="UserCenter_PasswordProtect" MasterPageFile="../MasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(".userCenter_Left_Nav_Item").eq(4).addClass("userCenter_Left_Nav_Item_Selected");
    </script>
</asp:Content>
