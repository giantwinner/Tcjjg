...
<body  style=" font-family:微软雅黑">
    ...
    <div class="SecurityCenter">
        ...
        <div id="valiDataChangePwd" runat="server">
            ...
            答<span style="visibility: hidden">空</span>案：<asp:TextBox CssClass="help_textBox"
                ID="txtAnswer1" runat="server" onblur="fnquestion1()" MaxLength="64"></asp:TextBox>&nbsp;<span
                    class="SecurityCenter_Error" id="questionError1"></span>
            <br />
            <br />
            问题二：<asp:Label ID="lblQuestion2" runat="server"></asp:Label><br />
            答<span style="visibility: hidden">空</span>案：<asp:TextBox CssClass="help_textBox"
                ID="txtAnswer2" runat="server" onblur="fnquestion2()" MaxLength="64"></asp:TextBox>&nbsp;<span
                    class="SecurityCenter_Error" id="questionError2"></span>
            <br />
            <br />
            问题三：<asp:Label ID="lblQuestion3" runat="server"></asp:Label><br />
            答<span style="visibility: hidden">空</span>案：<asp:TextBox CssClass="help_textBox"
                ID="txtAnswer3" runat="server" onblur="fnquestion3()" MaxLength="64"></asp:TextBox>&nbsp;<span
                    class="SecurityCenter_Error" id="questionError3"></span>
            <br />
            <br />
            <div id="btnChangePwd2" class="SecurityCenter_BtnOK" style="margin-left: 80px" onclick="fnValidataQuestion()">
            </div>
            <span class="SecurityCenter_Error" id="validataReturn" style="margin-left: 80px">
            </span>
        </div>
