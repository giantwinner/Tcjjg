...
public partial class PayCenter_Yeepay : BasePageIB
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        {
            PublicClass.WriteErrLog("充值中心-易宝充值-提交易宝前。" + "充值用户：" + user.UserName +
            ".充值数量：" + amount + ".银行标记：" + YFlag + ".创建IP：" + createIP + ".错误标记：" + opeCreateYeepayLog);
        ...
        //ScriptManager.RegisterStartupScript(Page, GetType(), "a", "<script type=\"text/javascript\" defer=\"defer\">fnClick('" + htmlCodeGet + "');</script> )", false);
