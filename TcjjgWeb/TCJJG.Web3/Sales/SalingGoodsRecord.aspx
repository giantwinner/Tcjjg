<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SalingGoodsRecord.aspx.cs" Inherits="AwardCenter_SalingGoodsRecord" %>
        ...
        <div class="subPage_Right">
            ...
            <div class="bigBorder">
                ...
                <div class="top-title">
                    我的交易-道具商城</div>
                <div class="bottom">
                    <asp:Repeater ID="rpGoodsPurchaseRecord" runat="server" OnItemCommand="rpGoodsPurchaseRecord_ItemCommand">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td height="59">
                                    <div align="center">
                                        <%# Convert.ToInt32(Eval("Amount")) * Convert.ToInt32(Eval("PriceInfo"))%>金币</div>
                                </td>
                                <td height="59">
                                    <div align="center">
                                        <%#Eval("CreateTime")%></div>
                                ...
                                <%--<td height="120">
                                <div class="btnHref">
                                <a href="GoodsPurchaseRecordTable.aspx?pid=<%#Eval("PurchaseID")%>" >详细</a></div>
                            </td>--%>
                                <td height="59">
                                    <div align="center">
                                        <asp:LinkButton ID="LButGoodsDle" OnClientClick="javascript:return confirm('您确认删除吗?')"
                                            CommandName="GoodsDle" CommandArgument='<%#Eval("PurchaseID")%>' runat="server">删除</asp:LinkButton>
                                    </div>
                                </td>
                            </tr>
                        </ItemTemplate>
