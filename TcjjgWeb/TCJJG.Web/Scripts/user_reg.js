...
function reg_ddl() {
    ...
    $("#ctxtUserName").html("4-15个字符，中、英文与数字组合的形式");
    $("#ctxtUserName").css("color", "#484747");
    $("#ctxtUserName").show();
    $("#userNameFinish").hide();
    $("#userNameError").hide();
}
function reg_areCheck() {
...
function O_Submit_btnOK1() {
    ...
    if (!checkValiRegOnblur('ctl00_ContentPlaceHolder1_valiNO')) {
        return false;
    }
...
function regFous_NickName() {
    ...
    $("#cnickName").html("4-15个字符，中、英文与数字组合的形式,不填则使用账号作为昵称。");
