...
//
function tap1click() {
    G("tap2").className = "head-tap-default";
    G("tap3").className = "head-tap-default";
    G("tap1").className = "head-tap-select";
    G("I_div_RegMain25_head_3").className = "div_RegMain25_head_2_amp";
    G("I_div_RegMain25_head_4").className = "displayNone";
    //
    G("vip-wrap").style.display = "none";
    G("updateHead-wrap").style.display = "block";
    G("defaultUserHeadBtn").style.display = "block";
//    G("defaultUserSexBtn").style.display = "block";
}
function tap3click() {
    G("tap1").className = "head-tap-default";
    G("tap2").className = "head-tap-default";
    G("tap3").className = "head-tap-select";
    G("updateHead-wrap").style.display = "none";
    G("vip-wrap").style.display = "block"; 
}
function tap2click() {
    G("tap1").className = "head-tap-default";
    G("tap3").className = "head-tap-default";
    G("tap2").className = "head-tap-select";
    //
    G("I_div_RegMain25_head_3").className = "displayNone";
