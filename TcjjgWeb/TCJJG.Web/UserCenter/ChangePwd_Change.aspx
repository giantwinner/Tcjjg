...
<body>
    <form id="form1" runat="server">
        <div id="startChangePwd"  class="uc-accountsafe-font" runat="server">
            ...
            <br />
            <br />
            <div id="btnChangePwd1" class="savebtn" style="margin-left: 130px" onclick="fnChangePwd()">
            确定
            </div>
            <span class="SecurityCenter_Error" id="validataReturn" style="margin-left: 130px">
            </span>
    ...
    function fnChangePwd() {
        ...
        if (lengthOld >= 6 && lengthNew >= 6 && lengthNew2 >= 6 && pwdNew == pwdNew2) {
            $.post("/Ajax/Ajax_ValidataPassWord.aspx", { UserID: userID, PwdOld: pwdOld, PwdNew: pwdNew, PwdNew2: pwdNew2 }, function (data) {
                ...
                if (jsonData == 0) {
                    $("#validataReturn").html("修改成功！");
                    $("#btnChangePwd1").attr("disabled", "disabled");
                }
                else if (jsonData == -1) {
