    ...
    <div class="SecurityCenter">
        <div id="setupQuestion">
            ...
            <div style="_margin-top: 6px">
                ...
                <asp:TextBox ID="setAnswer1" runat="server" onblur="fnQuestion1()"
            ...
            <div style="_margin-top: 6px">
                <span style="visibility: hidden">占</span>答案：
                <asp:TextBox  ID="setAnswer2" runat="server" onblur="fnQuestion2()"
                    MaxLength="64" Width="164px"></asp:TextBox>
            ...
            <div style="_margin-top: 6px">
                <span style="visibility: hidden">占</span>答案：
                <asp:TextBox  ID="setAnswer3" runat="server" onblur="fnQuestion3()"
                    MaxLength="64" Width="164px"></asp:TextBox>
                &nbsp;<span class="SecurityCenter_Error" id="errorTXT3"></span>
            </div>
            <div id="btnSetupQuestion" class="savebtn" style="margin-top: 20px;
                margin-left: 55px;">
                确定
            </div>
            <span class="SecurityCenter_Error" id="validataReturn" style="margin-left: 55px">
            </span>
        </div>
        <div id="verificaQuestion" style="display: none">
            ...
            <br />
            <span style="visibility: hidden">占</span>答案：
            <asp:TextBox  ID="valiAnswer2" runat="server" onblur="fnAnswer2()"
                MaxLength="64"></asp:TextBox>
            &nbsp;<span  id="errorAnswer2" class="SecurityCenter_Error"></span>
            <br />
            <br />
            问题二：
            ...
            <br />
            <span style="visibility: hidden">占</span>答案：
            <asp:TextBox ID="valiAnswer3"  runat="server" onblur="fnAnswer3()"
                MaxLength="64"></asp:TextBox>
            &nbsp;<span  id="errorAnswer3" class="SecurityCenter_Error"></span>
            <br />
            <br />
            问题三：
            ...
            <br />
            <span style="visibility: hidden">占</span>答案：
            <asp:TextBox ID="valiAnswer1"  runat="server" onblur="fnAnswer1()" 
                MaxLength="64"></asp:TextBox>
            &nbsp;<span  id="errorAnswer1" class="SecurityCenter_Error"></span>
            <br />
            <div id="btnVerificaQuestion" class="savebtn" style="margin-top: 20px;
                margin-left: 55px;">确定
            </div>
            <span class="SecurityCenter_Error" id="errorVerifica" style="margin-left: 55px">
            </span>
        </div>
