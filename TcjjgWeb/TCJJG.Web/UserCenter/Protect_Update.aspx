...
<body>
    ...
    <div class="SecurityCenter">
        ...
        <div id="verificaQuestion" class="help_right_setupQuestion">
            ...
            <asp:TextBox  ID="valiAnswer1" runat="server" MaxLength="64" onblur="fnAnswer1()"></asp:TextBox>
            ...
            <br />
            <span style="visibility: hidden">占</span>答案：
            <asp:TextBox  ID="valiAnswer2" runat="server" MaxLength="64" onblur="fnAnswer2()"></asp:TextBox>
            ...
            <br />
            <span style="visibility: hidden">占</span>答案：
            <asp:TextBox  ID="valiAnswer3" runat="server" MaxLength="64" onblur="fnAnswer3()"></asp:TextBox>
