<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Goods.aspx.cs" Inherits="HelpCenter_Goods" %>
  ...
  <%--      <div class="uc-content-r">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var g = QueryString("intr");
            if (null != g) {
                $(".help_nav_item").eq(g).addClass("help_nav_item_sel");
                $(".help_content").eq(g).show();

                var num = $(".help_nav_item").eq(g).attr("id");
